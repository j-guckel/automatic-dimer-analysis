...
Block4_Start = parameter_file.index('[Segmentation Parameters]\n')
Block5_Start = parameter_file.index('[Pre-Processing Parameters]\n')
...
Block4 = parameter_file[Block4_Start+1:Block5_Start]
Block5 = parameter_file[Block5_Start+1:]
...
cluster_threshold = ast.literal_eval(Block3[13])
origami_threshold = ast.literal_eval(Block3[15])

#Analysis of Block 4:
select_segmentation_mode = ast.literal_eval(Block4[3])
...
use_inverse_bandpass = ast.literal_eval(Block4[13])

#Analysis of Block 5:
gauss_sigma = ast.literal_eval(Block5[1])
data_bar_length = ast.literal_eval(Block5[3])
